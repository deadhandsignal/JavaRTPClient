...
public class CcrRtpClient extends JFrame implements ActionListener,KeyListener,MouseListener,ItemListener {
		...
		private JButton startRec,playButton,buttonHelp,buttonStop,remTarg,radioInfo,okRTP,buttonSess; 
		private JToolBar toolBar;
		private JMenuBar menuBar;
		private JMenu menuFile, menuTools, menuHelp;
		private JMenuItem menuItem,menuItemPlay,menuItemHelp,menuItemDispSchedule,menuItemParams,menuItemRtpSess,menuItemClose,menuItemOpenRtp,menuItemEditDispSchedule;
   ...
   }catch(Exception e)
   {
        ...
        menuItemDispSchedule = new JMenuItem("Display Week's Daily Schedules");
        menuTools.add(menuItemDispSchedule);
        menuItemDispSchedule.addActionListener( this);
		...
		pack();
		setTitle( "Cork Campus Radio RTP Client");
...
// Panel methods for Main JFrame--------------------------------------------------------
    ...
    //Edit Schedule
    else if (source == menuItemDispSchedule) {
