...
//make the connection to the database table.
   ...
   protected void setDBConnection(String theDataBase,String username,String password)
...

   {
      ...
      protected void setResultSet(String query) throws SQLException
   {	
   ...
   protected void setTable(Vector rows, Vector columnNames)
   {
